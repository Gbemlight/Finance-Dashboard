...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Appwrite throws an Error-like object; show a readable message
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-10 md:px-20 lg:px-32 bg-white">
        ...
        {/* Welcome Text */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-1 text-[#000000]">
            Welcome back
          </h2>
          <p className="text-[#78778B] text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-[#1B212D] mb-1">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center space-x-2">
              ...
              <span className="text-[#1B212D] text-[14px]">
                Remember for 30 Days
              </span>
            </label>
            <Link
              href="#"
              className="text-[#1B212D] text-[14px] hover:underline"
            >
              Forgot password
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-[#C8EE44] hover:bg-lime-500 text-[#1B212D] font-medium py-2 rounded-md transition disabled:opacity-50"
            disabled={loading}
          >
      ...
      <div className="hidden md:flex items-center justify-center bg-gray-50 min-h-screen">
        <div className="relative w-full h-full flex items-center justify-center">
          {/* Image wrapper must be position:relative and have explicit size for next/image fill */}
